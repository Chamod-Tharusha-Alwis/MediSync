  ...
  return (
    <div className="min-h-screen bg-[#0b1120] flex items-center justify-center p-4 relative overflow-hidden">
      <motion.div 
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-blue-500/10 blur-[120px] rounded-full pointer-events-none" 
      />
      ...
      >
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl p-8 overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-400 text-sm mt-2">Sign in to access your medical records</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center py-3 px-4 border border-blue-600/50 rounded-xl shadow-sm text-sm font-medium text-white bg-blue-600/80 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 focus:ring-offset-[#0b1120] transition-colors disabled:opacity-70 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
            ...
            <div className="mt-4 text-center">
              <button type="button" onClick={() => navigate('/register?role=patient')} className="text-sm text-slate-400 hover:text-white transition-colors">
