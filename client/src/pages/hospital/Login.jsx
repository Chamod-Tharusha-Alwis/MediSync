  ...
  return (
    <div className="min-h-screen bg-[#0b1120] flex items-center justify-center p-4 relative overflow-hidden">
      <motion.div 
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-indigo-500/10 blur-[120px] rounded-full pointer-events-none" 
      />
      ...
      >
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl p-8 overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-indigo-500 via-blue-400 to-indigo-500" />
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-white tracking-tight">Hospital Administration</h2>
            <p className="text-slate-400 text-sm mt-2">Sign in to hospital dashboard</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center py-3 px-4 border border-indigo-600/50 rounded-xl shadow-sm text-sm font-medium text-white bg-indigo-600/80 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-[#0b1120] transition-colors disabled:opacity-70 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
            ...
            <div className="mt-4 text-center">
              <button type="button" onClick={() => navigate('/register?role=hospital')} className="text-sm text-slate-400 hover:text-white transition-colors">
